...
namespace dbl_pend_ctrl {
    void DataLogger::Configure(const Entity &_entity,
    ...
    void DataLogger::PostUpdate(const UpdateInfo &_info, const EntityComponentManager &_ecm)
    {
        ...
        auto forceComp_1 = _ecm.Component<components::JointForce>(joint_1);
        auto forceComp_2 = _ecm.Component<components::JointForce>(joint_2);
